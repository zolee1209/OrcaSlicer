...
void Sidebar::priv::layout_printer(bool isBBL, bool isDual)
{
    ...
    // ORCA: unified nozzle combo also drives non-BBL dual-extruder printers (e.g. IDEX),
    // which have no AMS dual-extruder UI of their own -- only hide it for the BBL dual UI.
